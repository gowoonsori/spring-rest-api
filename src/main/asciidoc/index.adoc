...
operation::get-events[snippets='curl-request,http-request,request-headers,request-body,request-fields,http-response,response-headers,response-body,response-fields,links']
